    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="text-muted mt-1">mbmbmb</div>
                <div class="navi mt-2">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="{{ route('frontend.profile') }}" class="navi-item">
                <div class="navi-link">
            ...
            <!--end:Item-->
            <!--begin::Item-->
            <a href="{{ route('frontend.pengaduan') }}" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">Pengaduan</div>
